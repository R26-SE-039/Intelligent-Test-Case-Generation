    ...
    <DashboardLayoutWrapper>
      ...
      <div className="sticky top-0 bg-white border-b border-slate-200 px-8 py-6 shadow-sm">
        ...
        <p className="text-slate-600 mt-1">
          WCAG 2.1 & Section 508 Compliance Audit
        </p>
      </div>
      ...
      <div className="p-8">
        <div className="bg-white rounded-lg border border-slate-200 p-8">
          <div className="flex items-start gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-600">
                Comprehensive WCAG 2.1 and Section 508 accessibility audit
                engine powered by Playwright and Axe-Core.
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-lg p-6">
            <p className="text-slate-600">
              Test details and results will appear here...
            </p>
          </div>
        </div>
      </div>
